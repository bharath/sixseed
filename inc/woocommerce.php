...
add_filter( 'woocommerce_enqueue_styles', 'sixseed_custom_woocommerce_styles' );
/**
 ...
 */
function sixseed_custom_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'sixseed_custom_woocommerce_css' );
/**
 ...
 */
function sixseed_custom_woocommerce_css() {
