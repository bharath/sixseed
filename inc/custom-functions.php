 ...
 */
function sixseed_custom_fonts_url() {
	...
	$montserrat   = esc_html_x( 'on', 'Montserrat font: on or off', 'sixseed' );
	$merriweather = esc_html_x( 'on', 'Merriweather font: on or off', 'sixseed' );
 ...
 */
function sixseed_scripts_styles() {
	...
	wp_enqueue_style( genesis_get_theme_handle() . '-custom-fonts', sixseed_custom_fonts_url(), [], genesis_get_theme_version() );
...
add_action( 'wp_enqueue_scripts', 'sixseed_scripts_styles', 11 );


/**
 * Enqueue Gutenberg editor styles and scripts
 */
function sixseed_gutenberg_scripts_styles() {
	...
	wp_enqueue_style( genesis_get_theme_handle() . '-custom-gutenberg-fonts', sixseed_custom_fonts_url(), [], genesis_get_theme_version() );
...
add_action( 'enqueue_block_editor_assets', 'sixseed_gutenberg_scripts_styles', 11 );
