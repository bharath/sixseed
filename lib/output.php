 ...
 * Sixseed.
 *
 * This file adds the required CSS to the front end to the Sixseed Theme.
 *
 * @package Sixseed
 * @author  Bharath
...
add_action( 'wp_enqueue_scripts', 'sixseed_css' );
/**
...
function sixseed_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'sixseed_logo_width', 350 );
