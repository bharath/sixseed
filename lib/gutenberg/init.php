...
add_action( 'wp_enqueue_scripts', 'sixseed_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 1.0.0
 */
function sixseed_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'sixseed_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 1.0.0
 */
function sixseed_block_editor_styles() {
...
add_filter( 'body_class', 'sixseed_blocks_body_classes' );
/**
 ...
 */
function sixseed_blocks_body_classes( $classes ) {
...
$sixseed_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$sixseed_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$sixseed_appearance['editor-color-palette']
);

require_once get_stylesheet_directory() . '/lib/gutenberg/inline-styles.php';

add_action( 'after_setup_theme', 'sixseed_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function sixseed_content_width() {

	$appearance = genesis_get_config( 'appearance' );

	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
	$GLOBALS['content_width'] = apply_filters( 'sixseed_content_width', $appearance['content-width'] );
