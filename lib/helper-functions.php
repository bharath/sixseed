 ...
 * Sixseed.
 *
 * This file adds the required helper functions used in the Sixseed Theme.
 *
 * @package Sixseed
 * @author  Bharath
 ...
 */
function sixseed_color_contrast( $color ) {
 ...
 */
function sixseed_color_brightness( $color, $change ) {
